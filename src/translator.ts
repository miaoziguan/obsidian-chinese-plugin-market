...
import { buildSelfHostedTranslators, type SelfHostedTranslator } from "./translate/self-hosted";
import { AISearcher } from "./search/ai";
...
import { TMDirtyTracker } from "./translate/tm-dirty";
import type { CompareItem } from "./plugin-insight";
import { InsightCache, type InsightEntry } from "./insight-cache";
import { AiAssetStore, type DictEntry } from "./ai-asset-store";
...
export { InsightCache, type InsightEntry } from "./insight-cache";
export { AiAssetStore, type DictEntry } from "./ai-asset-store";
...
export class Translator {
	...
	setVectorIndex(vi: import("./embedding").VectorIndex | null) {
