...
import type { PluginDetailDrawer } from "./detail-drawer";
import { type SignalId } from "./smart-signal";
import { type ListState } from "./list-state";
import { TrendingEngine } from "./recommend/trending";
import { InvertedIndex } from "./recommend/similar";
import { type AuthorGroup } from "./pinyin-init";

import type ChinesePluginMarketPlugin from "./plugin";
// ──────────────────────────────────────────
// 常量
// ──────────────────────────────────────────
...
import { VIEW_TYPE, LAYOUT } from "./constants";
...
import { loadAndRender, updateGuidance, updateFacetVisibility, showSearchGuide, showAIPendingHint, showAIConfigGuide, showLoadingState, updateStats, applyAIConfig, announceStatus, updateScrollButtons, updateScrollPosBadge } from "./view-chrome";
...
import { runAISearch } from "./view-ai-search";
import { renderPluginList, recomputeSmartSignalsIfNeeded, runFilterPipeline, updateListChrome, invalidateAndRender, postRenderSync, refreshCardState, measureLayout, measureLayoutIfNeeded, scheduleRender, renderWindow, fillVisibleWindow, disposeRenderTimers } from "./view-render";
import { onCardClick, toggleFavorite, onCardKeydown, focusCardByIdx, flashAction, computeSimilarFor, openDetailDrawer as _openDetailDrawer } from "./view-cards";
import { renderFeaturedSection, ensureFeaturedSection, hideFeaturedSection } from "./view-featured";
import { createViewContext, type ViewContext } from "./view-context";
import { updateCompareTray, openCompareModal, enterCompareMode, exitCompareMode } from "./view-compare";
import { disposeComparePage } from "./compare-view";
...
export class ChinesePluginMarketView extends ItemView {
  ...
  /** 当前打开的详情抽屉（与对比模式互斥，同时只能存在一个） */
	...
	/** 界面文案函数，返回中文文案 */
	public readonly t: (key: I18nKey, vars?: import("./i18n").I18nVars) => string = makeT();
