...
import type { PluginInfo, TranslateResult, AISearchResult, Translator } from "./translator";
import type { DrawerHostPlugin } from "./detail-drawer";
import type { SearchMode, SourceFilter, InstallFilter, FilterCache, EmptyState } from "./filter";
import type { SortBy } from "./sort";
import type { PluginStat } from "./stats";
import type { SimilarCandidate } from "./recommend/similar";
import type { InvertedIndex } from "./recommend/similar";
...
import type { TrendingEngine } from "./recommend/trending";
import type { AuthorGroup } from "./pinyin-init";

import type { I18nKey, I18nVars } from "./i18n";
import type { ChinesePluginMarketSettings, ChinesePluginMarketView } from "./translator-view";
